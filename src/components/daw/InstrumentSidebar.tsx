...
import { Drum, Music, FileAudio, Plus, Trash2, Pencil, Loader2, AlertCircle, Play, Repeat, Repeat1 } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { useState } from 'react';

export function InstrumentSidebar() {
  const { state, dispatch, previewSound, previewSample, addSampleTrack } = useDAW();
